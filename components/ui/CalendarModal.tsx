...
const CalendarModal: React.FC<CalendarModalProps> = ({
  ...
  // États pour la sélection d'heure (web uniquement)
  ...
  const selectDate = (day: number) => {
    if (Platform.OS === 'web') {
      // Sur web, on stocke le jour sélectionné
      setSelectedDay(day);
    } else {
  ...
  // Fonction pour confirmer la sélection (web uniquement)
      ...
      <View style={styles.modalOverlay}>
        <View id='modalContainer' style={[styles.modalContainer, { maxHeight: Platform.OS === 'web' ? '90%' : '100%' }]}>
          ...
          <View style={styles.calendarContainer}>
            ...
            {/* Sélection d'heure pour web uniquement */}
            {Platform.OS === 'web' && (
            ...
            {/* Boutons d'action pour web uniquement */}
            {Platform.OS === 'web' && (
